...
# подключаем библиотеку графического интерфейса
from tkinter import *
import time
...
def main():
    ...
    generate_packets_btn = Button(frame4, text="Сгенерировать сетевые пакеты", width=35, 
        command=lambda: generate_packets(ddos_generator, process_lb, dest_ip_edit.get(), dest_port_edit.get(), bots_count_edit.get()))
