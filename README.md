...
**Целью** настоящей курсовой работы является изучение особенностей DDoS-атак, исследование возможностей применения различных
методов машинного обучения для детектирования аномального и нормального трафиков в сети, а также практическое применение
знаний, навыков и умений, полученных при изучении дисциплины «Технологии и методы программирования» на основе разработки
прототипа программного продукта для решения прикладной или системной задачи.

Для достижения поставленной цели были выделены следующие **задачи**:

1. Изучить материалы, посвященные DDoS-атакам;
2. Ознакомиться с принципами машинного обучения;
3. Рассмотреть методы машинного обучения: градиентный бустинг, нейронные сети;
4. Изучить библиотеку для манипулирования сетевыми пакетами;
5. Разработать утилиту для генерации аномального и нормального трафиков;
6. Отобрать данные для обучения моделей машинного обучения и провести их предварительную обработку;
7. Обучить модели на отобранных данных;
